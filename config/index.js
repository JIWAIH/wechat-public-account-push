export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxf7c7c1780d69afad",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "335ba7ce7019f7fb7fb151b2d0ab5907",
  ...
  USERS: [
    {
      ...
      id: "oXUyd552Pd97WstR1BCRZA2Y6qI0",
      // 你想对他发送的模板消息的模板ID
  ...
  CALLBACK_TEMPLATE_ID: "uZFgAGifNZl-PcWQ8i6ieeGazcIg78s-8YZELn9p7UE",
